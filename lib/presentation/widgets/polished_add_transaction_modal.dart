...
class PolishedAddTransactionModal extends StatefulWidget {
  const PolishedAddTransactionModal({super.key});

  @override
  State<PolishedAddTransactionModal> createState() => _PolishedAddTransactionModalState();
}

class _PolishedAddTransactionModalState extends State<PolishedAddTransactionModal>
